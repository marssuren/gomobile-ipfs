...
// 全部注释掉，测试哪些是必要的
// replace (
// 	// 多地址替换为适配Android SDK30的版本
// 	github.com/multiformats/go-multiaddr => github.com/gfanton/go-multiaddr v0.7.1-0.20221109002011-e39b3a49e793
//
// 	// 模块路径变更映射
// 	github.com/lucas-clemente/quic-go => github.com/quic-go/quic-go v0.39.0
// 	github.com/ipfs/go-libipfs => github.com/ipfs/boxo v0.16.0
// 	github.com/marten-seemann/qpack => github.com/quic-go/qpack v0.4.0
// 	github.com/marten-seemann/qtls-go1-18 => github.com/quic-go/qtls-go1-18 v0.2.0
// 	github.com/marten-seemann/qtls-go1-19 => github.com/quic-go/qtls-go1-19 v0.3.0
// 	github.com/marten-seemann/webtransport-go => github.com/quic-go/webtransport-go v0.6.0
//
// 	// IPFS组件路径变更
// 	github.com/ipfs/go-ipfs-cmdkit/files => github.com/ipfs/boxo/files v0.16.0
// 	github.com/ipfs/kubo/core/bootstrap => github.com/ipfs/boxo/bootstrap v0.16.0
// 	github.com/ipfs/go-ipfs-cmds => github.com/ipfs/go-ipfs-cmds v0.9.0
// 	github.com/libp2p/go-nat => github.com/libp2p/go-nat v0.2.0
//
// 	// 特殊测试包替换
// 	github.com/multiformats/go-multiaddr/matest => github.com/multiformats/go-multiaddr-fmt v0.1.0
//
// 	// 保留的移动端特定替换（如果需要）
// 	golang.org/x/mobile => github.com/berty/mobile v0.0.9
// )
